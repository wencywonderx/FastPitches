...
export OUTPUT_DIR=$DS_HOME/fastpitch_audio/range/$(basename ${PHRASES} .tsv) #-----------------changed
export BATCH_SIZE=100  # this might need to be bigger than #utts in $PHRASES... #-------------------changed
